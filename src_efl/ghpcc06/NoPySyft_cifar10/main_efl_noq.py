...
#z_FILE = "g_nw_d_euclidean_partition_noniid-#label2_nclient100.npy.part.10" 
#"g_no_vw_knn5_d_euclidean_CNN_P1.6m_B10_L20_non_iid_zipfz0.7.part.8"
#z_FILE = "g_d_euclidean_partition_noniid-labeldir0.175_nclient1000.npy.part.35"
#z_FILE = "g_nw_d_euclidean_partition_noniid-labeldir0.175_nclient1000.npy.part.35"
#PRE_TRAINED_W_FILE = "eFL_non_iid_B10_L205_E2_G10000_MNIST_zipfz0.7_g_d_euclidean_L50_non_iid_zipfz0.7.part.5.weight.pth"
#PRE_TRAINED_W_FILE = "eFL_MLP2_B10_L40_E2_G500000_g_d_euclidean_partition_noniid-labeldir0.175_nclient1000.npy.part.35.weight.pth"
...
def parse_args():
    ...
    parser.add_argument('--z-file', dest='z_file', help='The assignment file', type=str, default=None)
...
def main(args):
    if args.mode == 'non_iid':
        ...
        #print("Training efl...")
        trainer = eFL(NUM_EDGE_SERVERS, NUM_CLIENTS, GLOBAL_ROUNDS, BATCH_SIZE, LEARNING_RATE, LR_DECAY, args.edge_update, args.global_update, w_DIR, z_DIR, acc_DIR, 
            z_file = args.z_file, 
            dataset = DATASET, mode = MODE, pre_trained_w_file = None, zipfz = None, partition_data_file = PARTITION_DATA_FILE)
