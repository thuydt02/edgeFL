...
#dict_partition = partition_data_82__(dataset, datadir, n_parties, dominate_class_ratio = 0.90)
#num_dominated_labels = 3
#dominate_class_ratio = 0.9
#partition = "noniid"+str(int(dominate_class_ratio * 100)) + "_label" + str(num_dominated_labels)
#dict_partition = partition_data_given_num_labels(dataset, datadir, n_parties, num_dominated_labels = num_dominated_labels, dominate_class_ratio = dominate_class_ratio)

percentage_data_distribution_fname = "../../output/cifar10/z_ass/data_size_zipfz0.5_nclient300.csv"
dominate_class_ratio = 0.9
partition = "zipfz0.5_noniid" + str(int(dominate_class_ratio * 100))
dict_partition = partition_data_given_data_size(dataset, datadir, n_parties, dominate_class_ratio = dominate_class_ratio, data_size_fname = percentage_data_distribution_fname)
...
#n_parties = 10
#dominate_class_ratio = 0.9
#partition = "noniid" + str(int(dominate_class_ratio * 100))

#dict_partition = partition_data_C1(dataset, datadir, n_parties)

#dict_partition = partition_data_82__(dataset, datadir, n_parties, dominate_class_ratio)
...
print("saved partition, data_size files:", partition_file, data_size_file)
