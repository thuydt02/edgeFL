import argparse
#from pre_train_for_distance_LR import pre_train     #binary logistic Regression
#from pre_train_for_distance_LR10 import pre_train   #10 class LR

#from pre_train_for_distance_BMLP import pre_train     #MLP
...
DATASET = "mnist" #"cifar10" #"femnist"#"mnist"#"cifar100"#"femnist"
...
PARTITION_DATA_FILE = "partition_noniid90_label2_nclient300.npy" #label3

#PARTITION_DATA_FILE = "partition_noniid_C1_nclient10.npy"
#PARTITION_DATA_FILE = "partition_noniid90_nclient10.npy"
...
#		z_dir = z_DIR, w_dir = w_DIR, dataset = DATASET, pre_trained_w_file = None, partition_data_file = PARTITION_DATA_FILE, distance_metric = args.distance_metric, p = args.p)
    #pretrain.get_distance_and_weight_files_in_round_steps(step = 200)
