...
class Trainer:
	def __init__(self, no_clients, learning_rate, batch_size, epochs, no_local_epochs, model_weight_dir, acc_dir):
		...
		self.w_file = "FL_non_iid_B" + str(batch_size) + "_L" + str(no_local_epochs) + "_G" + str(epochs) + ".weight.pth"
	...
	def train(self):
		...
		for epoch in range(self.epochs):
			...
			with open(self.acc_dir + self.acc_file, 'a') as the_file:
				the_file.write(str(epoch) + "," + str(accuracy) + "\n")
